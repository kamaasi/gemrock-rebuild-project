...
import { ArrowRight, Star, Shield, Clock, Trophy, Sparkles, Diamond } from 'lucide-react';
...
const Index = () => {
  ...
  const categories = [
    { name: 'Diamonds', count: 234, icon: Diamond, image: 'photo-1506630448388-4e683c67ddb0?w=300' },
    { name: 'Rubies', count: 156, icon: Sparkles, image: 'photo-1515562141207-7a88fb7ce338?w=300' },
    { name: 'Sapphires', count: 189, icon: Star, image: 'photo-1506630448388-4e683c67ddb0?w=300' },
    { name: 'Emeralds', count: 98, icon: Shield, image: 'photo-1515562141207-7a88fb7ce338?w=300' },
  ];

  const stats = [
    { label: 'Active Auctions', value: '1,234', icon: Clock },
    { label: 'Registered Bidders', value: '45,678', icon: Trophy },
    { label: 'Items Sold', value: '234,567', icon: Star },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="text-lg px-8 py-3 border-white text-white hover:bg-white hover:text-purple-900" asChild>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row max-w-md mx-auto gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-lg border-0 focus:outline-none focus:ring-2 focus:ring-purple-300"
            />
